        ...
        >
          <Card className="cursor-pointer">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-h4">{agent.name}</h3>
                  <p className="text-body-sm text-gray-600">{agent.persona}</p>
                </div>
              </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-body-sm text-gray-500">Knowledge Level</span>
              <Badge variant={getBadgeVariant(agent.knowledgeLevel)}>
                {agent.knowledgeLevel}
              </Badge>
            </div>
            
            <div className="flex items-center justify-between">
              <span className="text-body-sm text-gray-500">Language Style</span>
              <span className="text-body-sm font-medium text-gray-900">{agent.languageStyle}</span>
            </div>
            
            <div className="flex items-center justify-between">
              <span className="text-body-sm text-gray-500">Emotional Range</span>
              <span className="text-body-sm font-medium text-gray-900">{agent.emotionalRange}</span>
            </div>
            
            <div className="flex items-center justify-between">
              <span className="text-body-sm text-gray-500">Hesitation</span>
              <span className="text-body-sm font-medium text-gray-900">{agent.hesitationLevel}</span>
            </div>
          </div>
